function Ring({ r, delay = 0, opacity = 0.18 }) {
  return (
    <circle cx="60" cy="60" r={r} fill="none" stroke="rgba(0,212,255,0.35)" strokeWidth="1"
    ...
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g style={{ animation: 'es-float 3.5s ease-in-out infinite', transformOrigin: '60px 60px' }}>
        <path d="M60 28 C60 28 42 38 42 58 L42 70 L38 74 L82 74 L78 70 L78 58 C78 38 60 28 60 28Z"
          fill="rgba(0,212,255,0.14)" stroke="rgba(0,212,255,0.55)" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M54 74 C54 77.3 56.7 80 60 80 C63.3 80 66 77.3 66 74"
          fill="rgba(0,212,255,0.20)" stroke="rgba(0,212,255,0.55)" strokeWidth="1.5" />
        <line x1="60" y1="28" x2="60" y2="22" stroke="rgba(0,212,255,0.40)" strokeWidth="1.5" strokeLinecap="round" />
        <circle cx="60" cy="20" r="3" fill="rgba(0,212,255,0.30)" />
      </g>
      <g style={{ animation: 'es-pulse 2s ease-in-out infinite' }}>
        <text x="28" y="46" fontSize="10" textAnchor="middle" fill="rgba(0,212,255,0.70)">✦</text>
        <text x="92" y="50" fontSize="8"  textAnchor="middle" fill="rgba(0,212,255,0.50)">✦</text>
        <text x="88" y="34" fontSize="6"  textAnchor="middle" fill="rgba(0,212,255,0.40)">✦</text>
      </g>
    </svg>
  )
}
  ...
  return (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g style={{ animation: 'es-float 3.2s ease-in-out 0s infinite', transformOrigin: '42px 60px' }}>
        <circle cx="42" cy="46" r="9" fill="rgba(0,212,255,0.20)" stroke="rgba(0,212,255,0.60)" strokeWidth="1.5" />
        <path d="M26 74 C26 64 34 60 42 60 C50 60 58 64 58 74"
          fill="rgba(0,212,255,0.14)" stroke="rgba(0,212,255,0.55)" strokeWidth="1.5" strokeLinecap="round" />
      </g>
      ...
      <g style={{ animation: 'es-pulse 2s ease-in-out infinite' }}>
        <circle cx="60" cy="60" r="9" fill="rgba(0,212,255,0.22)" stroke="rgba(0,212,255,0.55)" strokeWidth="1.5" />
        <line x1="60" y1="55" x2="60" y2="65" stroke="rgba(0,212,255,0.90)" strokeWidth="1.8" strokeLinecap="round" />
        <line x1="55" y1="60" x2="65" y2="60" stroke="rgba(0,212,255,0.90)" strokeWidth="1.8" strokeLinecap="round" />
      </g>
    </svg>
  )
}
    ...
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g style={{ animation: 'es-pulse 2s ease-in-out 0.5s infinite' }}>
        <path d="M60 32 L60 20 M60 20 L54 26 M60 20 L66 26"
          stroke="rgba(0,212,255,0.70)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      </g>
  ...
  return (
    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g style={{ animation: 'es-float 3s ease-in-out infinite', transformOrigin: '60px 55px' }}>
        <circle cx="60" cy="55" r="24" fill="rgba(0,212,255,0.08)" stroke="rgba(0,212,255,0.45)" strokeWidth="1.5" />
        <circle cx="60" cy="55" r="2" fill="rgba(0,212,255,0.80)" />
        <line x1="60" y1="55" x2="60" y2="40" stroke="rgba(0,212,255,0.90)" strokeWidth="1.8" strokeLinecap="round" />
        <line x1="60" y1="55" x2="70" y2="62" stroke="rgba(0,212,255,0.70)" strokeWidth="1.5" strokeLinecap="round" />
        {[0,30,60,90,120,150,180,210,240,270,300,330].map((deg, i) => {
          ...
          return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="rgba(0,212,255,0.30)" strokeWidth="1" />
        })}
      </g>
    </svg>
  )
