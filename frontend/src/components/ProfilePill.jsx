...
// Person-with-check "friends" icon (lucide UserCheck), shown when you're
// already friends — replaces the + add-friend button.
function FriendIcon() {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke={ONLINE} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" role="img" aria-label="Friends" style={{ flexShrink: 0 }}>
  ...
  return (
    ...
    >
      ...
      {showButton && (
        ...
        >
          {friendStatus === 'friends' ? <FriendIcon /> : btn.glyph}
        </button>
      )}
    </div>
  )
