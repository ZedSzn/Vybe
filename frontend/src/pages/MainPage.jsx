...
export default function MainPage() {
  ...
  return (
    ...
    >
      ...
      {/* ══════════════ EARN BANNER ══════════════ */}
      <div
        className="relative z-10 w-full flex flex-wrap items-center justify-center gap-2 sm:gap-3 px-4 py-2.5 text-[13px]"
        style={{ background: 'linear-gradient(90deg, rgba(124,58,237,0.18) 0%, rgba(37,99,235,0.14) 50%, rgba(124,58,237,0.18) 100%)', borderBottom: '1px solid rgba(124,58,237,0.2)', marginTop: '64px' }}
      >
        <span
          className="flex-shrink-0 px-2 py-0.5 rounded-full text-[10px] font-black tracking-wide uppercase"
          style={{ background: 'rgba(124,58,237,0.35)', color: 'rgba(167,139,250,1)' }}
        >New</span>
        <span className="flex items-center gap-1.5" style={{ color: 'rgba(210,210,230,0.8)' }}>
          <DollarSign size={13} style={{ color: 'rgba(167,139,250,0.9)' }} />
          <span className="text-white font-semibold">Get paid to live chat.</span><span className="hidden sm:inline"> Earn real money from gifts sent by viewers during your sessions.</span>
        </span>
        <button
          onClick={() => navigate('/earn')}
          className="flex-shrink-0 font-bold text-[12px] underline underline-offset-2 transition-opacity hover:opacity-70"
      ...
      <section className="relative z-10 pt-4">
        <div className="grid grid-cols-1 lg:[grid-template-columns:1fr_1.85fr_1.15fr] gap-5 px-4 sm:px-6 lg:px-10 py-6 lg:py-8 items-center w-full">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px]" style={{ color: '#6b7280' }}>online now</p>
              </div>
            </div>
          ...
          <motion.div
            className="relative rounded-3xl overflow-hidden order-3 lg:order-none"
            style={{
              background: '#0d0d18',
